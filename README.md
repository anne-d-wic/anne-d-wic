...
Data Analyst building decision-oriented analytics workflows across Power BI, SQL Server, Python, and DAX.
...
A PMO analytics dashboard designed to monitor portfolio delivery, risk exposure, and budget-related performance across projects and milestones.
...
An industrial operations dashboard designed to track production output, downtime, efficiency, and shift-level performance across manufacturing activity.
